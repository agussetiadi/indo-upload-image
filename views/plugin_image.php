...
<script type="text/javascript" src="<?php echo base_url()."assets/js/bootstrap/bootstrap.bundle.js" ?>"></script>
<script type="text/javascript" src="<?php echo base_url()."assets/js/myPlugins/imageUpload.js" ?>"></script>
...
<div class="container">
	<div class="col-md-12">
		...
		<form action="" id="formSendFile" method="POST" enctype="multipart/form-data">
			...
			<img class="img-responsive img-thumbnail" id="imgOrigin" src="<?php echo base_url()."assets/img/male.jpg" ?>">
			<input type="file" name="IsName" class="isClass" id="fileData">
			<input type="text" name="" id="wrapResult" value="male.jpg">
